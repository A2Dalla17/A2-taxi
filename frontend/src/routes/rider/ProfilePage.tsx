      ...
      <div className="stagger">
        ...
        <section className="mt-4 px-gutter">
          <div className="grid grid-cols-4 gap-2.5">
            <Shortcut icon={<Heart size={19} />} label="Places" to="/app/favourites" />
            <Shortcut icon={<Bell size={19} />} label="Alerts" to="/app/notifications" />
            <Shortcut icon={<ShieldAlert size={19} />} label="Safety" to="/app/safety" />
            <Shortcut icon={<LifeBuoy size={19} />} label="Help" to="/app/support" />
          </div>
        </section>
          ...
          <Card padded={false}>
            ...
            {loadingRides ? (
              ...
              <ul className="space-y-2.5 px-5 pb-5">
                {trips.map((ride) => (
                  <li key={ride.id}>
                    <TripCard ride={ride} to={`/app/track/${ride.id}`} />
                  </li>
                ))}
              </ul>
            )}
