    ...
    <div className="min-h-full bg-surface pb-[calc(7rem+var(--safe-bottom))]">
      ...
      <header className="flex items-center justify-between px-5 pb-1 pt-[calc(0.75rem+var(--safe-top))]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <IconButton label="Messages" onClick={() => navigate('/app/messages')}>
      ...
      <div className="stagger">
        ...
        {activeRide && (
          <section className="px-5 pt-5">
            <button
              type="button"
              onClick={() => navigate(`/app/track/${activeRide.id}`)}
  ...
  return [
    {
      ...
      to: has('home') ? '/app/book?favourite=home' : '/app/favourites',
    },
    {
      label: 'Work',
      icon: <Briefcase size={19} />,
      to: has('work') ? '/app/book?favourite=work' : '/app/favourites',
    },
    { label: 'Saved', icon: <Heart size={19} />, to: '/app/favourites' },
    { label: 'History', icon: <Clock size={19} />, to: '/app/trips' },
  ];
}
